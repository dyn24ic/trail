...
export default function RouteAnalysisPanel({ hybridRoute, onDismiss }: Props) {
  ...
  return (
    ...
    >
      ...
      >
        <span
          style={{ color: "#00ffc8", fontWeight: 700, letterSpacing: "0.1em" }}
        >
          ◈ ROUTE ANALYSIS
        </span>
      ...
      >
        ...
        <div style={{ display: "flex", gap: "16px", flexWrap: "wrap" }}>
          <div style={{ flex: 1, minWidth: "120px" }}>
            ...
            <div
              style={{ color: "#22d3ee", fontSize: "18px", fontWeight: 700 }}
            >
          ...
          <div style={{ flex: 1, minWidth: "120px" }}>
            ...
            <div
              style={{ color: "#00ffc8", fontSize: "18px", fontWeight: 700 }}
            >
          ...
          <div style={{ flex: 1, minWidth: "120px" }}>
            ...
            <div
              style={{ color: "#7ab8b0", fontSize: "18px", fontWeight: 700 }}
            >
        ...
        >
          ...
          <span style={{ color: "rgba(122,184,176,0.7)" }}>
            {Math.round(weather.wind_speed_ms * 3.6)} km/h{" "}
            {windDir(weather.wind_direction_deg)}
          </span>
          {weather.precipitation_mm_1h > 0 && (
            <span style={{ color: "#60a5fa" }}>
              💧 {weather.precipitation_mm_1h.toFixed(1)} mm/h
            </span>
          )}
        </div>
        ...
        {/* AI summary */}
        <div style={{ color: "#a0ccc8", lineHeight: 1.5 }}>
          {analysis.summary}
        </div>
        ...
        {analysis.hazards.length > 0 && (
          <div style={{ display: "flex", flexDirection: "column", gap: "3px" }}>
            ...
            {analysis.hazards.map((h, i) => (
              <div key={i} style={{ color: "#ef4444", fontSize: "11px" }}>
                ▸ {h}
              </div>
            ))}
          </div>
        ...
        {analysis.turn_by_turn.length > 0 && (
          <div>
            ...
            >
              {turnByTurnOpen ? "▾" : "▸"} Turn-by-turn directions (
              {analysis.turn_by_turn.length} steps)
            </button>
            {turnByTurnOpen && (
              <div
                style={{
